package com.jatin.ems_backend.security.security.services;

import com.jatin.ems_backend.security.entities.User; // Import User model
import com.jatin.ems_backend.security.repository.UserRepository; // Import UserRepository for user database operations
